            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 mt-2 sm:mt-0 ">
              ...
              <div className="flex gap-6 items-center ">
                <div className="bg-gray-200 rounded-lg p-2 flex items-center">
                  ...
                  <input
                    type="text"
                    className="bg-slate-200 text-gray-500 w-20 md:w-40 placeholder:text-gray-500 outline-none font-avalonB"
                    placeholder="search..."
                  />
                </div>
              </div>
            ...
            <table className="w-full text-sm text-left text-gray-500">
              ...
              <tbody>
                <tr className="bg-white border-b hover:bg-gray-50 animate-pulse">
                  ...
                  >
                    <div className="bg-slate-200 h-full w-full text-slate-200">
                      a
                    </div>
                  </td>
                  <td className="px-4 py-3  p-1">
                    {" "}
                    <div className="bg-slate-200 h-full w-full text-slate-200">
                      a{" "}
                    </div>
                  ...
                  <td className="px-4 py-3 flex gap-2 p-1 ">
                    <div className="bg-slate-200 h-full w-full text-slate-200 ">
                      a
                    </div>
                  </td>
    ...
    <div className="px-4 sm:px-8 py-4">
      <div className="bg-white md:h-[800px] lg:h-[500px] rounded-lg overflow-hidden shadow-lg">
        <div className="flex sm:flex-row items-center justify-between p-4">
          ...
          <div className="flex flex-col sm:flex-row gap-2 sm:gap-4 mt-2 sm:mt-0 ">
            <button
              className="p-2 bg-[#E6612A] font-semibold border font-avalonB border-orange-600 hover:shadow-lg hover:-translate-y-0.5 duration-200 transition rounded-lg text-white text-sm"
              onClick={() => {
              ...
              {filteredProducts.map((item, index) => (
                <tr key={index} className="bg-white border-b hover:bg-gray-50">
                  ...
                  <td className="px-4 py-3 flex gap-2 ">
                    <button
                      className="p-1 px-2 flex justify-center items-center group  font-semibold border border-[#E6612A] hover:shadow-lg hover:-translate-y-0.5 duration-200 transition rounded-lg  text-white text-sm"
                      onClick={() => {
                        handleEdit(item._id);
                      }}
                    >
                    ...
                    <button
                      className="p-1 px-2 flex justify-center items-center group  font-semibold border border-gray-500 hover:shadow-lg hover:-translate-y-0.5 duration-200 transition rounded-lg  text-white text-sm"
                      onClick={() => {
