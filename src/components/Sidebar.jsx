      ...
      <nav>
        ...
        {Click && (
          <div className=" mt-2 space-y-2 lg:hidden group-hover:block ">
            ...
            <Link
              to="/products/list"
              className={` py-2 px-4 rounded transition duration-200 flex gap-2  ${location.pathname === '/products/list' ? 'text-white ' : 'hover:text-white'}`}
