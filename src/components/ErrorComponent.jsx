  ...
  return (
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
        <div class="mx-auto max-w-screen-sm text-center">
            ...
            <Link to="/dashboard" class="inline-flex text-black bg-[#F4EAD1] border border-[#B98230] hover:shadow-lg hover:-translate-y-1 duration-200 transition   font-medium rounded-lg text-sm px-5 py-2.5 text-center -primary-900 my-4">Back to Homepage</Link>
        </div>   
    </div>
</section>
  )
