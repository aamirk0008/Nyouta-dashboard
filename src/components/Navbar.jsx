...
export default function Navbar({setIsMobileMenuOpen}) {
  return (
    <div className="w-full h-[10%] py-2 px-8 bg-slate-200 flex justify-between ">
        <div className="flex items-center"><h1 className=' capitalize lg:text-2xl text-gray-500 font-semibold flex items-center '><span className='me-2 block lg:hidden'  ><i class="fa-solid fa-bars" onClick={()=>{setIsMobileMenuOpen(true)}}></i></span>WELCOME!</h1></div>
        <div className="flex gap-6 items-center ">
            <div><i class="fa-solid fa-moon text-gray-500"></i></div>
            <div><i class="fa-solid fa-bell text-gray-500"></i></div>
